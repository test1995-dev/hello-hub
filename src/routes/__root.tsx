  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          مشکلی پیش آمده است. می‌توانید دوباره تلاش کنید یا به صفحه اصلی بازگردید.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "مطب دکتر یاسمن دانشیان | دندان‌پزشکی زیبایی" },
      {
        name: "description",
        content: "دندان‌پزشکی زیبایی و ترمیمی در تهران؛ رزرو نوبت آنلاین، طرح درمان شفاف و پیگیری پس از درمان.",
      },
